...
<!-- <div class="header"><h4>Teacher Dashboard</h4></div> -->
    ...
    <div class="main">
        <form class="form_a" action="<?php $_SERVER['PHP_SELF']; ?>" method="post"> 
         ...
         <h5> Student's Serial:
         <input type="text" name="student_serial" placeholder="Put Student's Serial:"></h5>
         <input type="submit" class= "btn" name= "Remove" id="submit" value="submit">
       ...
       if(isset($_POST['Remove'])){
        ...
        $sql="DELETE FROM $coursename WHERE Student_serial='$Student_serial'";
